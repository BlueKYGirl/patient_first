...
VALUES ('CHAAAACHIIIII', 'er34289yh2uhg', 'doctor');
...
VALUES (3, 'Chachi', 'TheCat', 'chachicat@meowmeow.com', '2003-01-03');
...
INSERT INTO phone_number(phone_type_id, phone_number, is_primary)
VALUES (1, '(123)456-7890', True);

INSERT INTO office(address_id, phone_id, practice_name, office_hours_start_time, office_hours_end_time)
VALUES (1, 1, 'Chachi & Associates', '8:00', '16:00');
